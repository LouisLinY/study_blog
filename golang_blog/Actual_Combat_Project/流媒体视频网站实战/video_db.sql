...
CREATE TABLE `sessions`  (
  `session_id` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `TTL` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `video_info`  (
  ...
  `display_ctime` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
